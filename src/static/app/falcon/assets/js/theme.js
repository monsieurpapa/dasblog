...
//       availability: JSON.parse(node_availability_data),
//     }
//   };
//   var tab_key=$('#cran-metrics-chart-tab .active').attr('href').replace('#', '');
//   // var tab_key=$('#cran-metrics-chart-tab .active').attr('id');
...
//   initChart(document.querySelector('.echart-cran-metrics'), getDefaultOptions(data.dataset.bandwidth[0], data.dataset.bandwidth[1]));

//   var tab = document.querySelector('#cran-metrics-chart-tab');
//   console.log('active_tab: ', $('#cran-metrics-chart-tab .active').attr('href').replace('#', ''))
...
//         var selected_tab = triggerEl.href.split('#').pop();
//         console.log('selected_tab: ', selected_tab)
//         tab_key=selected_tab;
//         var $echartCranMetricsTab = document.getElementById(selected_tab).querySelector('.echart-cran-metrics');
//         // var $echartCranMetricsTab = document.querySelector('.echart-cran-metrics-' + selected_tab);        
//         console.log('$echartCranMetricsTab: ', $echartCranMetricsTab)        
//         initChart($echartCranMetricsTab, getDefaultOptions(data.dataset[selected_tab][0], data.dataset[selected_tab][1]));
//         var chart = window.echarts.init($echartCranMetricsTab);
//         switch (selected_tab) {
//           case 'jitter':
//             // initChart($echartCranMetricsTab, getDefaultOptions(data.dataset.jitter[0], data.dataset.jitter[1]));
//             chart.setOption({  
//               xAxis: {
//                 data: utils.convertEpochToDateTime(data.dataset.jitter[1]),
//               },           
//               series: [{
//                 data: data.dataset.jitter[0]
//               }]
//             });             
//             break;

//           case 'loss':
//             // initChart($echartCranMetricsTab, getDefaultOptions(data.dataset.loss[0], data.dataset.loss[1]));
//             chart.setOption({  
//               xAxis: {
//                 data: utils.convertEpochToDateTime(data.dataset.loss[1]),
//               },           
//               series: [{
//                 data: data.dataset.loss[0]
//               }]
//             });             
//             break;

//           case 'latency':
//             // initChart($echartCranMetricsTab, getDefaultOptions(data.dataset.latency[0], data.dataset.latency[1]));
//             chart.setOption({  
//               xAxis: {
//                 data: utils.convertEpochToDateTime(data.dataset.latency[1]),
//               },           
//               series: [{
//                 data: data.dataset.latency[0]
//               }]
//             });             
//             break;

//           case 'bandwidth':
//             // initChart($echartCranMetricsTab, getDefaultOptions(data.dataset.bandwidth[0], data.dataset.bandwidth[1]));
//             chart.setOption({  
//               xAxis: {
//                 data: utils.convertEpochToDateTime(data.dataset.bandwidth[1]),
//               },           
//               series: [{
//                 data: data.dataset.bandwidth[0]
//               }]
//             });             
//             break;  
            
//           case 'availability':
//             // initChart($echartCranMetricsTab, getDefaultOptions(data.dataset.availability[0], data.dataset.availability[1]));            
//             chart.setOption({  
//               xAxis: {
//                 data: utils.convertEpochToDateTime(data.dataset.availability[1]),
//               },           
//               series: [{
//                 data: data.dataset.availability[0]
//               }]
//             });            
//             break;
//           }        
